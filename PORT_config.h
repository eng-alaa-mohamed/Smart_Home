...
/* CHOOSE: 0 for Input 
           1 for Output   or you can add in config hash define #input 0   #output 1   */
...
/* CHOOSE: 0 for LOW if output & floating if input
           1 for HIGH if Output OR pull up if it's input pin*/
